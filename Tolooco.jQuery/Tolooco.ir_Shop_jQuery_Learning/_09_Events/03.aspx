<%@ Page Language="C#" AutoEventWireup="true" CodeFile="03.aspx.cs" Inherits="Events_04" %>
        ...
        <div>
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    $("#eventTarget").bind("click", function (eventArgs) {
                        $("#eventTarget").unbind("mouseover mouseleave", highlight);
                        $("#eventTarget").html("<p>You shut off the hover effect!</p>");
                    });
                })
